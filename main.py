...
if __name__ == "__main__":
    ...
    # File paths
    excel_file_location = os.path.join(directory, "Original_Data/UkraineSupportTracker.xlsx")
    config_file_location = os.path.join(directory, "Code/DataPipeline/pipeline_config.yaml")
    country_categories_location = os.path.join(directory, "Original_Data/country_categories.yaml")
