...
class PledgeStockServer:
    ...
    def create_plot(self):
        ...
        fig.add_trace(go.Bar(
            ...
            text=[f"{v:.1f}" if v > 0 else "" for v in data['delivered'].multiply(100)],
            textposition="inside",
            textfont=dict(color="white"),
            insidetextanchor="middle",
            hovertemplate="Delivered: %{x:.1f}%",
        ))
        ...
        fig.add_trace(go.Bar(
            ...
            text=[f"{v:.1f}" if v > 0 else "" for v in data["to_be_delivered"].multiply(100)],
            textposition="inside",
            textfont=dict(color="white"),
            insidetextanchor="middle",
            hovertemplate="To Be Delivered: %{x:.1f}%",
        ))
        ...
        fig.update_layout(
            ...
            hovermode="y unified",  # This creates the unified hover effect with dotted line
