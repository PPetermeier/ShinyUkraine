            ...
            ui.card_header(
                ui.div(
                    ...
                    ui.div(
                        ...
                        ui.div(
                            {"class": "card-subtitle text-muted mb-4"},  # Added margin bottom
...
class ColdWarServer:
    def __init__(self, input, output, session):
        ...
        self.color_map = {
            'US in Korea (average mil. exp. 1950-53)': COLOR_PALETTE['us_korea_war'],
            'US in Vietnam (average mil. exp. 1965-75)': COLOR_PALETTE['us_vietnam_war'],
            'US in Iraq (average mil. exp. 2003-2010)': COLOR_PALETTE['us_iraq_war'],
            'US in Afghanistan (average mil. exp. 2001-10)': COLOR_PALETTE['us_afghanistan_war'],
            'US to Ukraine (total military aid)': COLOR_PALETTE['us_ukraine_support']
        }
    ...
    def create_plot(self):
        ...
        for _, row in df.iterrows():
            ...
            fig.add_trace(
                go.Bar(
                    ...
                    orientation='h',
                    name=legend_name,
                    marker_color=self.color_map[conflict_name],
        ...
        fig.update_layout(
            ...
            xaxis_title="Billion 2022 Euros" if show_absolute_values else "% of US GDP",
            ...
            title=dict(
                ...
                x=0.5,
                y=0.95,  # Adjusted to create more space
                yanchor='top',
                xanchor='center',
                font=dict(size=16),
            ...
            legend=dict(
                orientation="h",
                yanchor="bottom",
                y=1.12,  # Increased distance from plot
                xanchor="center",
                x=0.5,
