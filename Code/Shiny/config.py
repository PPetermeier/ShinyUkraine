...
COLOR_PALETTE = {
    ...
    # US Wars Comparison Colors
    "us_korea_war": "#2ca02c",  # Distinct green
    "us_vietnam_war": "#98df8a",  # Lighter green
    "us_iraq_war": "#d62728",  # Red
    "us_afghanistan_war": "#ff7f0e",  # Orange
    "us_ukraine_support": "#1f77b4",  # Blue
}
